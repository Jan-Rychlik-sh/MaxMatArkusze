...
<body>
    ...
    <header>
        <a href="index.php" title="Powrót do strony głównej">
            <h1>Kontakt z Maksymilianem Rychlińskim</h1>
        </a>
    </header>
    <main id="container">
        <div class="concact_option">Telefon: <a href="tel:+48536301320">+48 536 301 320</a></div>
        <div class="concact_option">E-mail: <a href="mailto:maxfrodo@wp.pl">maxfrodo@wp.pl</a></div>
